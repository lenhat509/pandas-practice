...
# num_ratings = book_ratings[['User 1', 'User 2', 'User 3', 'User 4']].count(axis=0)
# print(num_ratings)
# average = np.sum(book_ratings[['User 1', 'User 2', 'User 3', 'User 4']], axis=0) / num_ratings
# print(average)
# book_ratings.fillna(average, axis=0, inplace=True)
# print(book_ratings)
